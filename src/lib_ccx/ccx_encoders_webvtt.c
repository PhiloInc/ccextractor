...
static const char** webvtt_pac_row_percent[] = { "10", "15", "21", "26", "31", "37", "42",
		"47", "53", "58", "63", "69", "74", "79", "85" };

static const char** webvtt_pac_col_percent[] = { "0", "3", "5.0", "8", "10", "13", "15",
		"18", "20", "23", "25", "28", "30", "33", "35", "38", "40", "43",
...
int write_webvtt_header(struct encoder_ctx *context)
{
	...
	} else if(!ccx_options.webvtt_no_css) {
